    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "summary_extracted": {
                    "type": "string",
                    "description": "Краткая выжимка из резюме: годы опыта, ключевые компании, основные роли и достижения. 3-5 предложений. НЕ пиши сюда контакты и общий стаж в годах — это меняется. Пиши только даты работы в конкретных компаниях.",
                },
            },
