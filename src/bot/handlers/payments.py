...
UPGRADE_TEXT = (
    ...
    "• До 3 резюме под вакансию в день вместо 1\n\n"
    "<b>Два варианта оплаты:</b>\n\n"
    "🔁 <b>990₽ / месяц</b> — продлевается автоматически. Для тех кто настроен искать обстоятельно.\n\n"
    "⚡️ <b>349₽ / неделя</b> — тоже с автопродлением, можно отменить в любой момент. Для тех кто хочет быстро попробовать.\n\n"
    "Оплата картой любого банка. После оплаты попадёшь в мой канал @{channel} — так работает Tribute. Там я делюсь апдейтами по боту и заметками о поиске работы. Не выходи из канала — подписка может отключиться."
)
