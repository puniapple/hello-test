...
WELCOME_TEXT_NEW = (
    ...
    "📝 <b>Составляет резюме под вакансию.</b> Структурирует опыт из профиля и загруженных резюме, подстраивает под вакансию и присылает документ резюме, оптимизированного под ATS проверки.\n\n"
    "💎 <b>Бесплатно или с Pro.</b>\n"
    "💎 <b>Как это работает.</b>\n"
    "Бот работает по подписке. До 3 подходящих вакансий в день, до 2 разборов соответствия, до 2 сопроводительных и до 2 резюме под вакансию.\n"
    "На неделю — 349₽, на месяц — 990₽. Выбрать тариф можно после знакомства.\n\n"
...
WELCOME_TEXT_RETURNING = (
    ...
    "/my_plan — посмотреть статус подписки\n"
...
HELP_TEXT = (
    ...
    "🎯 Разбираю каждую вакансию — что совпадает с профилем, чего не хватает, стоит ли откликаться\n"
    "📄 Собираю персональное резюме под вакансию\n"
    "✍️ Пишу сопроводительные письма\n"
    "📝 Понимаю голосовые\n"
    "📎 Читаю PDF с резюме и подгружаю инфу в профиль\n\n"
    "Команды:\n"
    "/edit_profile — обновить или дополнить профиль\n"
    "/my_plan — статус подписки\n"
    "/upgrade — оформить или продлить подписку\n"
    "/pause — пауза поиска\n"
...
async def cmd_stats(message: Message) -> None:
    ...
    if not matches:
        await message.answer("Пока ни одной вакансии не присылал.")
        return
