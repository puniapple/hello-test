...
WELCOME_TEXT = (
    ...
    'BD, продукт, EdTech, новые ниши — бот ловит резонанс, а не только ключевые слова.\n\n'
    '🔍 <b>Сам обходит источники.</b> Каждые 3 часа проверяет авторские карьерные '
    'TG-каналы и страницы компаний (мы не используем агрегаторы — там слишком много мусора). '
    'Через AI оценивает каждую вакансию под твой профиль и присылает только релевантное '
    'с объяснением, почему подошло.\n\n'
    '🎙 <b>Общайся как удобно.</b> Можно писать текстом, наговаривать голосовыми, '
    'присылать резюме PDF — бот всё разберёт и вытащит фактологию сам.\n\n'
