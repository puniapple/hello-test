...
WELCOME_TEXT_NEW = (
    ...
    "Бесплатно — 1 подборка в день, до 3 вакансий, 1 сопроводительное в день, 1 резюме. Нужна подписка на мой канал.\n"
    "С Pro — несколько подборок в день, до 5 вакансий в каждой, до 5 сопроводительных и 3 резюме в день. На неделю — 349₽, на месяц — 990₽. Выбрать можно после знакомства.\n\n"
