...
WELCOME_TEXT = (
    ...
    '🔍 <b>Сам обходит источники.</b> Каждые 8 часов проверяет авторские карьерные '
...
async def _send_subscription_gate(message: Message) -> None:
    ...
    text = (
        ...
        f"Там я пишу о карьере, выгорании и ценностях, и собираю из этого "
        f"практичные подходы — как делать работу и карьеру иначе.\n"
        f"После подписки нажми кнопку — продолжим."
    )
